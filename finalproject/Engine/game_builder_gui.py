...
def create_game_gui():
    ...
    audio_genre_dropdown = ttk.Combobox(input_frame, textvariable=audio_genre_var, values=["Action", "Adventure", "Horror", "Sci-Fi", "Fantasy", "Mystery"])
    ...
    protagonist_dropdown = ttk.Combobox(input_frame, textvariable=protagonist_var, values=["protagonist1.png", "protagonist2.png", "protagonist3.png"])
    ...
    target_dropdown = ttk.Combobox(input_frame, textvariable=target_var, values=["target1.png", "target2.png", "target3.png"])
    ...
    physics_dropdown = ttk.Combobox(input_frame, textvariable=physics_var, values=["Classic", "Quantum", "Relativistic"])
    ...
    collision_dropdown = ttk.Combobox(input_frame, textvariable=collision_var, values=["Bounce", "Explode", "Disappear"])
    ...
    # Create Game button calles Create Game function to start loop
    create_game_button = ttk.Button(window, text="Create Game", command=lambda: create_game(values_dict))
